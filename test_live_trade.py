...
async def test_live_trading():
    ...
    # SAFETY GUARD: If balance is 0, inputs are likely disabled by the UI.
    if balance_before == 0:
        print("    WARNING: Balance is 0. Trading inputs are likely DISABLED by the UI.")
        print("    Skipping trade execution to avoid timeout/crash.")
        print("    Possible reasons: Empty wallet, wrong selector, or UI not fully loaded.")
